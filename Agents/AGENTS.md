...
Runs Claude Code, OpenCode, Pi, or Ante against Harbor datasets in parallel zellij
workers.
...
[Harbor-pi/STRUCT.md](Harbor-pi/STRUCT.md), and
[Harbor-ante/STRUCT.md](Harbor-ante/STRUCT.md).
