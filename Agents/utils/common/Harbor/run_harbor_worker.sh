...
run_claimed_task() {
  ...
  (
    ...
    if harbor_agent_is_opencode; then
      ...
      export DSH_VERSION DSH_RUNTIME_BASENAME DSH_RUNTIME_VERSION_BASENAME
      export DSH_MINIMAL_SDK_VERSION DSH_MINIMAL_RUNTIME_BASENAME DSH_MINIMAL_RUNTIME_VERSION_BASENAME DSH_MINIMAL_PYTHON_RUNTIME_BASENAME DSH_MINIMAL_MAX_TOKENS
      export DSH_SDK_MINIMAL_DSH_VERSION DSH_SDK_MINIMAL_SOURCE_REF DSH_SDK_MINIMAL_SOURCE_SHA DSH_SDK_MINIMAL_SOURCE_DIR
      export DSH_SDK_MINIMAL_RUNTIME_BASENAME DSH_SDK_MINIMAL_RUNTIME_VERSION_BASENAME
      export DSH_SDK_MINIMAL_DSH_RUNTIME_BASENAME DSH_SDK_MINIMAL_DSH_RUNTIME_VERSION_BASENAME DSH_SDK_MINIMAL_MAX_TOKENS
      export DSH_PROVIDER DSH_THINKING_FORMAT DSH_PERMISSION_MODE DSH_THINKING DSH_REASONING_EFFORT
      export DSH_TEMPERATURE DSH_MAX_TOKENS DSH_CONTEXT_WINDOW
      export DSH_PROVIDER_RETRY_MAX DSH_REQUEST_TIMEOUT_MS DSH_STREAM_IDLE_TIMEOUT_MS DSH_API_KEY DSH_BASE_URL
