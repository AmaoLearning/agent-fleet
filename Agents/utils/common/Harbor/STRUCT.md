...
| `YICLOUD_SANDBOX_COMMAND_READY_TIMEOUT_SEC` | Bounded retry window for transient `429`/`502`/`503`/`504` responses while a new Sandbox command proxy becomes ready, default `90` |
